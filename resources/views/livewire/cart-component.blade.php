    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            ...
            <div class="wrap-iten-in-cart">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="delete">
                            <a href="#" class="btn btn-delete" title="">
                                ...
                                <i class="fa fa-times-circle" aria-hidden="true" wire:click.prevent="removeproduct('{{ $item->rowId }}')"></i>
                            </a>
                        </div>
                    </li>  
                    @endforeach
                ...
                @else
                    <p class="alert alert-info text-center text-primary">No product added yet</p>
                @endif
